...
class CStockPattern8(object):
    ...
    def SelectAll(self):
            ...
            resultDf.to_excel(f'''{root}/{self.N}日内放量大阳线.xlsx''',index=False)
            ...
            DataFrameToJPG(resultDf,("股票代码","股票名称"),root,f'''{self.N}日内放量大阳线''')
            print(resultDf)
